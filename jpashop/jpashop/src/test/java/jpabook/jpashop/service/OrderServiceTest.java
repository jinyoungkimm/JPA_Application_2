...
class OrderServiceTest {
    ...
    public void 상품주문() throws Exception{
        ...
        //givien
        Member member = setMember("회원1", new Address("서울", "해운대", "123"));

        Book book = setBook("시골 JPA", 10000, 10);
    ...
    private Book setBook(String name, int price, int stockQuantity) {
        Book book = new Book();
        book.setName(name);
        book.setPrice(price);
    ...
    private Member setMember(String name, Address address) {
    ...
    public void 주문취소() throws Exception{
        ...
        //Given
        Member member = setMember("회원1", new Address("서울", "해운대", "123"));
        Book item = setBook("시골 JPA", 10000, 10); //이름, 가격, 재고
        int orderCount = 2;
